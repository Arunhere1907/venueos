    ...
    >
      {isSuccess ? (
        <div className="py-8 text-center space-y-3">
          ...
          <h3 className="text-lg font-bold text-slate-900">Issue Ticket Logged</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
                {venues.map(v => (
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
