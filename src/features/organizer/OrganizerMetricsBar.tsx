    ...
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
      ...
      <div
        className={`p-4 rounded-2xl border transition-all ${
          pendingSOS.length > 0
            ? 'bg-rose-50 dark:bg-rose-950/40 border-rose-300 dark:border-rose-900 shadow-sm animate-pulse'
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <span className={`p-2 rounded-xl ${pendingSOS.length > 0 ? 'bg-rose-600 text-white' : 'bg-slate-100 text-slate-600'}`}>
      ...
      {/* 5. Broadcast Count */}
      <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 col-span-2 lg:col-span-1">
        <div className="flex items-center justify-between">
          <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">
            Broadcast Feed
          </span>
